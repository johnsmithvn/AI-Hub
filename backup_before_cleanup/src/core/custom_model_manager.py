...
class CustomModelManager:
    ...
    def __init__(self):
        ...
        # Ollama client - initialized if available
    ...
    def _init_ollama_client(self):
        """Initialize Ollama client if available and configured"""
        try:
            import ollama
            ...
            try:
                ...
                response = ollama.list()  # This will fail if server is not running
            ...
            logger.info("Ollama package not installed. Ollama integration disabled.")
            self.ollama_client = None
